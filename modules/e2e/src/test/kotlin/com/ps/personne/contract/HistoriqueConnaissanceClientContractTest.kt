...
import FixedTestClockWithFixedIncrement
import TestApp
...
class HistoriqueConnaissanceClientContractTest : ShouldSpec(
    {
        ...
        FixedTestClockWithFixedIncrement.apply {
            startInstant(Instant.parse("2026-01-20T10:30:19Z"))
            incrementBy(Duration.ofMinutes(20))
        }
                ...
                [
                    {
                        ...
                        "idObjet": "12345",
                        "occurredAt": "2026-01-20T10:30:19Z",
                        "performedBy": "JeanMich"
                    },
                    {
                        "changements": [
                            {
                        ...
                        "idObjet": "12345",
                        "occurredAt": "2026-01-20T10:50:19Z",
