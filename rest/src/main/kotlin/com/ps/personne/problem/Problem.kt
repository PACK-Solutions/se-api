...
class ProblemBuilder(
     ...
     * @param baseUrl (optional) given for an absolute path to type (recommended but not mandatory)
     */
    fun type(
        type: String,
        baseUrl: String? = "",
...
class Problem(
    ...
    companion object {
        /**
         * Creates a problem detail just with an HTTP status code (not a full problem detail since the type will be 'about:blank')
         ...
         * @param baseUrl url to make type route to an absolute path
         */
        fun of(
        ...
        /**
         * Creates a problem detail with an HTTP status code, type (with absolute path), detail and an error code.
         * @param httpStatusCode HTTP code of the problem
         * @param problemType relative path to the problem type
         * @param problemDetail detail description of the problem
         * @param baseUrl url to make type route to an absolute path
